#!/bin/bash -e
# vanilla_baseline: upstream Redis (cloned at vanilla_redis_tag), no migrate,
# no reshard, sync YCSB. Apples-to-apples baseline for the aqueduct fork.
#
# Usage:
