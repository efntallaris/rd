...
struct commandHelp {
  ...
  char *since;
    ...
    "2.6.0" },
    { "initRDMAServer",
    "RDMA_HOST RDMA_PORT RDMA_CLIENT_HOST RDMA_CLIENT_PORT",
    "Initiate RDMA SERVER at RDMA_HOST with port RDMA_PORT and a client connecting Connecting from RDMA_CLIENT HOST to the RDMA_HOST Server.",
    0,
    "2.6.0" },
    { "MODULE LIST",
    "-",
