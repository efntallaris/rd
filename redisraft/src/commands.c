...
static const CommandSpec commands[] = {
 ...
 /* RedisRaft Commands */
    ...
    {"rdma|chain-wire",             CMD_SPEC_DONT_INTERCEPT                      },
    {"rdma|chain-forwarded",        CMD_SPEC_DONT_INTERCEPT                      },
    {"rdma|chain-ack",              CMD_SPEC_DONT_INTERCEPT                      },
    {"rdma|chain-ping",             CMD_SPEC_DONT_INTERCEPT                      },
    {"rdma|debug-chain-establish",  CMD_SPEC_DONT_INTERCEPT                      },
    {"rdma|debug-chain-forward",    CMD_SPEC_DONT_INTERCEPT                      },
    {"rdma|debug-chain-status",     CMD_SPEC_DONT_INTERCEPT                      },
    {"rdma|debug-chain-apply-slot", CMD_SPEC_DONT_INTERCEPT                      },
    /* Aqueduct RDMA migration subcommands — must bypass redisraft routing so
     * the existing cluster_rdma.c handlers see them unchanged. */
    {"rdma|init-server",            CMD_SPEC_DONT_INTERCEPT                      },
    {"rdma|init-client",            CMD_SPEC_DONT_INTERCEPT                      },
    {"rdma|migrate",                CMD_SPEC_DONT_INTERCEPT                      },
    {"rdma|migrate-all",            CMD_SPEC_DONT_INTERCEPT                      },
    {"rdma|migrate-all-status",     CMD_SPEC_DONT_INTERCEPT                      },
    {"rdma|migrate-complete",       CMD_SPEC_DONT_INTERCEPT                      },
    {"rdma|migrate-prep",           CMD_SPEC_DONT_INTERCEPT                      },
    {"rdma|migrate-status",         CMD_SPEC_DONT_INTERCEPT                      },
    {"rdma|register-block-slots",   CMD_SPEC_DONT_INTERCEPT                      },
    {"rdma|register-result",        CMD_SPEC_DONT_INTERCEPT                      },
    {"rdma|reshard",                CMD_SPEC_DONT_INTERCEPT                      },
    {"rdma|reshard-flip",           CMD_SPEC_DONT_INTERCEPT                      },
    {"rdma|reshard-recv-flip",      CMD_SPEC_DONT_INTERCEPT                      },
