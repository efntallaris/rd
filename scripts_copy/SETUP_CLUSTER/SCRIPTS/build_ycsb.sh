...
sudo tar -xvf ycsb-redis-binding-0.17.0.tar.gz --directory ${YCSB_INTERMEDIATE_FOLDER}
...
sudo cp -rf ${YCSB_INTERMEDIATE_FOLDER}/ycsb-redis-binding-0.17.0/*  ${YCSB_BIN}
