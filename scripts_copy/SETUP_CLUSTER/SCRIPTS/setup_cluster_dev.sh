...
REDIS_PORT="8000"
REDIS_WORKLOAD="../workloads_dev/workloadreadonly"
...
sleep 5
cd $YCSB_DIR
#ycsbCommand=$( sudo ./ycsb load redis -p "redis.host=127.0.0.1" -p "redis.port=8000" -p "redis.cluster=true" -P ../workloads/workloadbb -p recordcount=40000000 -threads 16 )
#ycsbCommand=$(sudo ./ycsb load redis -p "redis.host=127.0.0.1" -p "redis.port=8000" -p "redis.cluster=true" -P ../workloads/workloada -p recordcount=60000000 -threads 16)
#ycsbCommand=$(sudo ./ycsb load redis -p "redis.host=${REDIS_HOST}" -p "redis.port=${REDIS_PORT}" -p "redis.cluster=true" -P ${REDIS_WORKLOAD} -p recordcount=${YCSB_RECORDS} -threads 5)
#ycsbCommand=$(sudo ./ycsb load redis -p "redis.host=${REDIS_HOST}" -p "redis.port=${REDIS_PORT}" -p "redis.cluster=true" -P ${REDIS_WORKLOAD} -p recordcount=${YCSB_RECORDS} -threads 100)
...
# BIGGER KEY VALUE SIZE
#ycsbCommand=$(sudo ./ycsb load redis -p "redis.host=127.0.0.1" -p "redis.port=8000" -p "redis.cluster=true" -P ../workloads/workloadaa -p recordcount=500000 -threads 16)
#ycsbCommand=$(sudo ./ycsb load redis -p "redis.host=127.0.0.1" -p "redis.port=8000" -p "redis.cluster=true" -P ../workloads/workloada -p recordcount=100000 -threads 16)
