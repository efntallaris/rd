...
source_lines["no_sleep"]="6365| |EXPERIMENTAL LINE TO BE CHANGED FROM SCRIPT"
source_lines["4_ms_sleep"]="6365|usleep(4000);|EXPERIMENTAL LINE TO BE CHANGED FROM SCRIPT"
source_lines["8_ms_sleep"]="6365|usleep(8000);|EXPERIMENTAL LINE TO BE CHANGED FROM SCRIPT"
source_lines["16_ms_sleep"]="6365|usleep(16000);|EXPERIMENTAL LINE TO BE CHANGED FROM SCRIPT"
source_lines["30_7_ms_sleep"]="6365|usleep(37000);|EXPERIMENTAL LINE TO BE CHANGED FROM SCRIPT"
...
echo "Line $line_number replaced with: $new_content"
    ...
    experimental_output=$(sudo ./experimental_setup.sh > /dev/null 2>&1)
