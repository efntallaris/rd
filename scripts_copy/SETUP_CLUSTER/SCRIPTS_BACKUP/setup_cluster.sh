...
YCSB_RECORDS="50000000"
REDIS_HOST="127.0.0.1"
REDIS_PORT="8000"
REDIS_WORKLOAD="../workloads/workloada"
...
ycsbCommand=$(sudo ./ycsb load redis -p "redis.host=${REDIS_HOST}" -p "redis.port=${REDIS_PORT}" -p "redis.cluster=true" -P ${REDIS_WORKLOAD} -p recordcount=${YCSB_RECORDS} -threads 200)
